<template>
	<form class="w-full" action="">
		<div
			class="w-[90%] grow lg:grow-0 lg:w-[298px] border-[1.5px] bg-[#F6F2F3] border-[#F6F2F3] focus-within:border-secondary transition-all duration-300 h-[40px] flex items-center px-5 gap-x-3"
		>
			<svg
				width="20"
				height="20"
